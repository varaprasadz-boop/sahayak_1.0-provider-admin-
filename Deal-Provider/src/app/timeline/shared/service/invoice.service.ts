...
export class InvoiceService {
    ...
    const invoice = {
      content: [
...

        {
          columns: [
            {
              text: 'Customer Invoice No: INV-SHK0012',
              color: '#000000',
              margin: [0, 12, 10, 20],
              bold: true,
              width: '*',
            ...
            {
              text: 'Invoice Date : ' + booking.date,
              color: '#000000',
              margin: [0, 12, 10, 20],
              bold: true,
              width: '*',
        ...
        },
        {
          table: {
            ...
            body: [
              [
                {
                  text: 'Amount In Words : ' + numWords(+booking.service.price),
                  bold: true,
                  fontSize: 10.6,
                  alignment: 'left',
                  border: [true, false, false, true],
  ...
  public generateProviderInvoice(booking: any, agent:any) : any {
    console.log(booking);
    const invoice = {
      content: [
        {
          columns: [
            ...
            [
              {
                text: 'Swayankrushi Home Services LLP',
                color: '#333333',
                width: '*',
                fontSize: 13,
                bold: true,
...

              {
                stack: [
                  {
                    text: '2-22-278 Plot.no. 12 BHEL Colony,',
                    color: '#aaaaab',
                    bold: true,
                    width: '*',
                    fontSize: 12,
...

        {
          columns: [
            {
              text: 'Invoice No: INVP-' + booking.bookingId,
              color: '#000000',
              margin: [0, 12, 10, 20],
              bold: true,
              width: '*',
                  ...
                  [
                    {
                      stack: [
                        ...
                        {
                          // text:  booking.paymentType+'\n  \n \n',
                          text: 'Transfer Mode: '+ booking?.transferMode +'\nTransfer ID: '+ booking?.transferID +'\n'+ '' +'\n ' + '',
                          alignment: 'left',
                          margin: [20, 5, 0, 5],
                        },
                      ],
